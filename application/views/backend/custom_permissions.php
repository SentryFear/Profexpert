<html>
	...
	<?php
		...
		echo form_checkbox('add', '1', $add);
		echo form_label('Allow add', 'add_label');
		echo '<br/>';
		...
		echo form_label('Allow print', 'print_label');
		echo '<br/>';
		
		echo form_input('request', $request);
		echo form_label(' Allow table fuild in request', 'request_label');
		echo '<br/>';
