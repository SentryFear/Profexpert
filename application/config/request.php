...
$config['instance'] = array(
                            ...
                            array('rname' => 'Проектно-инвентаризационное бюро', 'ins' => '1', 'names' => array('pid', 'ptp', 'sp', 'ptppib', 'ppib')),
                                array('rname' => 'Получение исходно-разрешительной документации', 'name' => 'pid', 'price' => '6000'),
                            ...
                            array('rname' => 'Комитет по градостроительству и архитектуре', 'ins' => '1', 'names' => array('pkga', 'zkga', 'skga', 'apzkga', 'sops', 'pokobl')),
                            ...
                            array('rname' => 'Районная Межведомственная комиссия', 'ins' => '1', 'names' => array('spvmvk', 'vove')),
                                array('rname' => 'Согласование проекта в МВК', 'name' => 'spvmvk', 'price' => '10000'),
