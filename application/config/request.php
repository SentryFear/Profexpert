...
$config['access'] = array(
    ...
    array('name' => 'Адрес',                          'value' => 'address',       'allow' => '2,3,6', 'self' => 'class="span4"'),
    array('name' => 'Адрес',                          'value' => 'address',       'allow' => '4', 'self' => 'class="span4"'),
    array('name' => 'Откуда узнали',                  'value' => 'hear',          'allow' => '0,2,3,6', 'view' => 0),
    array('name' => 'Дополнительная информация',      'value' => 'more',          'allow' => '0,2,3,4,6', 'view' => 0, 'type' => 'textarea', 'self' => 'class="span3 wysihtml5" rows="5"'),
    ...
    array('name' => 'Файлы',                          'value' => 'vdocs',         'allow' => '2,3,4,6', 'self' => 'class="span1"', 'form' => 0),
    array('name' => 'Комент',                         'value' => 'comments',      'allow' => '2,3,4,6', 'self' => 'class="span1"', 'form' => 0),
    array('name' => 'Статус',                         'value' => 'status',        'allow' => '2,3,4,6', 'self' => 'class="span1"', 'form' => 0),
    array('name' => 'Работники',                      'value' => 'workers',       'allow' => '2,6', 'self' => 'class="span1"', 'form' => 0),
    ...
    array('name' => 'Действия',                       'value' => 'actions',       'allow' => '2,3,4,6', 'self' => 'width="5%"', 'form' => 0, 'self' => 'class="span1"')
);
?>